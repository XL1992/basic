    ...
    <div class="container-fluid">
        <div id="pad-wrapper" class="users-list">
                    ...
                    <?php foreach ($users as $user): ?>
                        <tr class="first">
                            <td>
                                ...
                                <?php else: ?>
                                    <img src="<?php echo $user->profile->avatar; ?>"
                                         class="img-circle avatar hidden-phone"/>
                                <?php endif; ?>
                            ...
                            <td class="align-right">
                                <a href="<?php echo yii\helpers\Url::to(['user/del','userid'=>$user->userid]) ?>" onclick="return confirm('确定要删除吗？')">删除</a></td>
                        </tr>
                    <?php endforeach; ?>
                    </tbody>
                </table>
            ...
            <div class="pagination pull-right">
                <?php
                echo yii\widgets\LinkPager::widget(['pagination' => $pager, 'prevPageLabel' => '&#8249', 'nextPageLabel' => '&#8250']);
                ?>
            </div>
            <!-- end users table --></div>
    </div>
